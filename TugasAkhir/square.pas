...
begin
  ...
  { Test lines }
  CohenSutherlandClip(50, 50, 250, 150, accept);    { Garis miring }
  CohenSutherlandClip(150, 50, 150, 250, accept);   { Garis vertikal }
  CohenSutherlandClip(50, 150, 350, 150, accept);   { Garis horizontal }
  CohenSutherlandClip(0, 0, 400, 300, accept);      { Garis diagonal }
