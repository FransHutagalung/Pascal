...
//   { Gambar lingkaran dalam mata }
//   SetFillStyle(SolidFill, Blue);
//   FillEllipse(CenterX, CenterY, Round(EyeWidth * 0.3), Round(EyeHeight * 0.3));
...
//   EyeWidth, EyeHeight: integer;
// begin
//   { Kurangi ukuran mata relatif terhadap segitiga }
//   EyeWidth := Round(TriangleSize * 0.3);    { Sebelumnya 0.5 }
//   EyeHeight := Round(TriangleSize * 0.15);   { Sebelumnya 0.25 }
